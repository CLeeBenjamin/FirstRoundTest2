...
//        
//        let restaurantListFiltered = self.restaurantList
//        var filterForArray = [Restaurant]()
//        
//        
//        for item in restaurantListFiltered {
//            
//            if restaurantListFiltered.contains(where: {$0.name == userSearch }) {
//                filterForArray.append(item)
//                
//                self.filteredList = filterForArray
//                
//            }
//            
//       
...
//                }
//
//                let predicateAddress = { (element: Restaurant) in
...
//                let dictionaryAddress = Dictionary(grouping: self.restaurantList, by: predicateAddress)
//
...
//                }
//
//                for (key, _ ) in dictionaryAddress {
//
//                    //MARK: - Inspections Dates
//                    addressArray.append(key)
//
//
//                }
//
...
//
//
//                    self.nameOfRestaurant = nameArray
//                    self.addressOfRestaurant = addressArray
//
//
//
...
//
//
//                if totalSumMinorPerDateArray.count > 2  {
//
//                    self.secondDateMinorNumber = reversedSumMinorPerDateArray[1]
//
//                } else {
//
//                    self.secondDateMinorNumber = 0
//
//                }
//
//
